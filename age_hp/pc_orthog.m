...
data = data(~isnan(data.sio2) & data.sio2 > 0 & data.sio2 < 100 &...
    ~isnan(data.k2o) & data.k2o > 0 &...
    ~isnan(data.na2o) & data.na2o > 0 &...
    ~isnan(data.heat_production) & data.heat_production > 0,:);


NoisyX = data.sio2;
NoisyY = data.k2o + data.na2o;
NoisyZ = data.heat_production;

CleanZ = -1.2705 + 0.0196.*NoisyX + 0.2440.*NoisyY;
